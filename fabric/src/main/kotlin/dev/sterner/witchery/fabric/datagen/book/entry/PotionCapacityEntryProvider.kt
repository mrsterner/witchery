    ...
    override fun generatePages() {
        ...
        this.page("${ID}_2") {
            BookPotionPageModel.create()
                ...
                .addItem(WitcheryItems.TEAR_OF_THE_GODDESS.get().defaultInstance, BookTextHolder(
                    Component.translatable("witchery.potion_crafting.tear_of_the_goddess", 1, 100)
                ))
                .addItem(WitcheryItems.PHANTOM_VAPOR.get().defaultInstance, BookTextHolder(
                    Component.translatable("witchery.potion_crafting.phantom_vapour", 1, 150)
                ))
                .addItem(Items.AMETHYST_SHARD.defaultInstance, BookTextHolder(
                    Component.translatable("witchery.potion_crafting.amethyst", 1, 200)
                ))
                .addItem(Items.HEART_OF_THE_SEA.defaultInstance, BookTextHolder(
        ...
        this.page("${ID}_3") {
            BookPotionPageModel.create()
                ...
                .addItem(WitcheryItems.PENTACLE.get().defaultInstance, BookTextHolder(
