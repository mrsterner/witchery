...
class WitcheryRecipeProvider(output: FabricDataOutput, val registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    override fun buildRecipes(exporter: RecipeOutput) {
        ...
        CauldronBrewingRecipeBuilder.create()
            .addInputWithColor(WitcheryItems.WHIFF_OF_MAGIC.get(), Color(255, 190, 190).rgb)
            .addInputWithColor(Items.COOKIE, Color(250, 200, 50).rgb)
            .addInputWithColor(WitcheryItems.ICY_NEEDLE.get(), Color(100, 150, 250).rgb)
            .addInputWithColor(WitcheryItems.BREW_OF_LOVE.get(), Color(195, 90, 160).rgb)
            .addInputWithColor(WitcheryItems.WATER_ARTICHOKE_GLOBE.get(), Color(255, 50, 250).rgb)
