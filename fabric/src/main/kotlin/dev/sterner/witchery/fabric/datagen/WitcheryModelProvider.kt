...
class WitcheryModelProvider(output: FabricDataOutput?) : FabricModelProvider(output) {
    ...
    override fun generateItemModels(genetaror: ItemModelGenerators) {
        ...
        genetaror.generateFlatItem(WitcheryItems.NECROMANTIC_SOULBIND.get(), ModelTemplates.FLAT_ITEM)
        ...
        genetaror.generateFlatItem(WitcheryItems.ETERNAL_CATALYST.get(), ModelTemplates.FLAT_ITEM)
        ...
        genetaror.generateFlatItem(WitcheryItems.PARASITIC_LOUSE.get(), ModelTemplates.FLAT_ITEM)
        ...
        genetaror.generateFlatItem(WitcheryItems.MOON_CHARM.get(), ModelTemplates.FLAT_ITEM)
        genetaror.generateFlatItem(WitcheryItems.SUNSTONE_PENDANT.get(), ModelTemplates.FLAT_ITEM)
        genetaror.generateFlatItem(WitcheryItems.BLOODSTONE_PENDANT.get(), ModelTemplates.FLAT_ITEM)
        genetaror.generateFlatItem(WitcheryItems.DREAMWEAVER_CHARM.get(), ModelTemplates.FLAT_ITEM)
        genetaror.generateFlatItem(WitcheryItems.BITING_BELT.get(), ModelTemplates.FLAT_ITEM)
        genetaror.generateFlatItem(WitcheryItems.BARK_BELT.get(), ModelTemplates.FLAT_ITEM)
        ...
        genetaror.generateFlatItem(WitcheryItems.BREW_OF_THE_GROTESQUE.get(), ModelTemplates.FLAT_ITEM)
        genetaror.generateFlatItem(WitcheryItems.HAPPENSTANCE_OIL.get(), ModelTemplates.FLAT_ITEM)
