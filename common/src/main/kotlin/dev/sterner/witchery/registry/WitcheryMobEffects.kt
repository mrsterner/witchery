...
object WitcheryMobEffects {
    ...
    val BANE_OF_ARTHROPODS_WEAPON: Holder<MobEffect> =
        register("bane_of_arthropods_weapon", BaneOfArthropodsWeaponMobEffect(MobEffectCategory.HARMFUL, Color(100, 70, 20).rgb))
    ...
    val ENDER_BOUND: Holder<MobEffect> = register("ender_bound", EmptyMobEffect(MobEffectCategory.HARMFUL, Color(255, 60, 210).rgb))
