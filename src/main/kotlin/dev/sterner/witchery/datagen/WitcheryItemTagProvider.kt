...
class WitcheryItemTagProvider(output: PackOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>, blockTags:  CompletableFuture<TagLookup<Block>> , existingFileHelper: ExistingFileHelper) :
    ...
    override fun addTags(wrapperLookup: HolderLookup.Provider) {
        ...
        tag(WitcheryTags.WEREWOLF_ALTAR_ITEM)
            .add(Items.GOLD_INGOT)
            .add(Items.MUTTON)

        tag(WitcheryTags.PLACEABLE_POPPETS)
        ...
        tag(WitcheryTags.FROM_SPIRIT_WORLD_TRANSFERABLE)
        ...
        tag(WitcheryTags.LEAF_ITEMS).add(
        ...
        tag(WitcheryTags.ROWAN_LOG_ITEMS).add(
        ...
        tag(WitcheryTags.ALDER_LOG_ITEMS).add(
        ...
        tag(WitcheryTags.HAWTHORN_LOG_ITEMS).add(
        ...
        tag(WitcheryTags.CANDELABRA_ITEMS).add(
        ...
        tag(ItemTags.LECTERN_BOOKS).add(
            WitcheryItems.GUIDEBOOK.get()
        )
        ...
        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "seeds"))).add(
            WitcheryItems.MANDRAKE_SEEDS.get(),
            WitcheryItems.BELLADONNA_SEEDS.get(),
            WitcheryItems.SNOWBELL_SEEDS.get(),
            WitcheryItems.WATER_ARTICHOKE_SEEDS.get(),
        ...
        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "crops"))).add(
        ...
        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dusts"))).add(
            WitcheryItems.WOOD_ASH.get()
        )

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "tools"))).add(
            WitcheryItems.BONE_NEEDLE.get(),
            WitcheryItems.ICY_NEEDLE.get(),
        ...
        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/white")))
            .add(WitcheryItems.WHITE_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/orange")))
        ...
        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/yellow")))
            .add(WitcheryItems.YELLOW_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/lime")))
            .add(WitcheryItems.LIME_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/pink")))
            .add(WitcheryItems.PINK_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/gray")))
        ...
        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/cyan")))
            .add(WitcheryItems.CYAN_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/purple")))
            .add(WitcheryItems.PURPLE_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/blue")))
            .add(WitcheryItems.BLUE_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/brown")))
            .add(WitcheryItems.BROWN_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/green")))
            .add(WitcheryItems.GREEN_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/red")))
            .add(WitcheryItems.RED_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "dyed/black")))
            .add(WitcheryItems.BLACK_IRON_CANDELABRA.get())

        tag(WitcheryTags.WOODEN_WEAPONS)
