...
class AncientTabletBlockEntityWithoutLevelRenderer : BlockEntityWithoutLevelRenderer(
    Minecraft.getInstance().blockEntityRenderDispatcher,
    Minecraft.getInstance().entityModels
) {

    private var model: AncientTabletModel? = AncientTabletModel(AncientTabletModel.createBodyLayer().bakeRoot())
    ...
    override fun renderByItem(
        ...
        model?.renderToBuffer(
            poseStack,
            buffer.getBuffer(RenderType.entityTranslucent(Witchery.id("textures/block/ancient_tablet.png"))),
            packedLight,
            packedOverlay
        )
