...
class ArmorPoppetModel(root: ModelPart) :
    ...
    companion object {
        val LAYER_LOCATION: ModelLayerLocation = ModelLayerLocation(Witchery.id("armor_poppet"), "main")
        fun createBodyLayer(): LayerDefinition {
            ...
            val rArm = base.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(14, 14)
                    ...
                    .texOffs(24, 12).addBox(-0.8f, -1.2f, -1.5f, 2.0f, 2.0f, 2.0f, CubeDeformation(0.0f)),
            ...
            val lArm = base.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(8, 10)
                    ...
                    .texOffs(24, 12).addBox(-0.3f, -1.2f, -1.5f, 2.0f, 2.0f, 2.0f, CubeDeformation(0.0f)),
            ...
            val body = base.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(0, 6)
                    ...
                    .texOffs(22, 6).addBox(-2.0f, -6.0f, -1.0f, 3.0f, 4.0f, 2.0f, CubeDeformation(0.1f)),
            ...
            val cube_r1 = bb_main.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(0, 26)
                    .addBox(-2.0f, -3.0f, -1.0f, 3.0f, 3.0f, 3.0f, CubeDeformation(0.1f)),
                PartPose.offsetAndRotation(0.3f, -8.0f, 6.5f, 0.1745f, 0.0f, 0.0f)
            )
