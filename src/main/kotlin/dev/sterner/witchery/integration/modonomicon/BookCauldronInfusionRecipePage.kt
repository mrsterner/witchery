...
class BookCauldronInfusionRecipePage(
    ...
    BookProcessingRecipePage<CauldronInfusionRecipe>(
        WitcheryRecipeTypes.CAULDRON_INFUSION_RECIPE_TYPE.get(),
        title1,
        recipeId1,
        title2,
        recipeId2,
    ...
    override fun getType(): ResourceLocation {
        return WitcheryPageRendererRegistry.CAULDRON_INFUSION_RECIPE
    }
    ...
    companion object {
        fun fromJson(
        ...
        ): BookCauldronInfusionRecipePage {
            ...
            return BookCauldronInfusionRecipePage(
                common.title1(),
                common.recipeId1(),
                common.title2(),
                common.recipeId2(),
        ...
        fun fromNetwork(buffer: RegistryFriendlyByteBuf): BookCauldronInfusionRecipePage {
