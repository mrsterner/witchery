...
import dev.sterner.witchery.data_gen.book.page.BookOvenFumingPageModel
    ...
    override fun generatePages() {
        this.page(ID) {
            BookSpotlightPageModel.create()
                .withItem(WitcheryItems.IRON_WITCHES_OVEN.get())
                .withTitle("${parent.categoryId()}.$ID.title.1")
                .withText("${parent.categoryId()}.$ID.page.1")
        }
        this.page("${parent.categoryId()}.${ID}.breath_of_the_goddess") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.breath_of_the_goddess.title.1")
        ...
        this.page("${parent.categoryId()}.${ID}.hint_of_rebirth") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.hint_of_rebirth.title.1")
        ...
        this.page("${parent.categoryId()}.${ID}.exhale_of_the_horned_one") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.exhale_of_the_horned_one.title.1")
        ...
        this.page("${parent.categoryId()}.${ID}.foul_fume_logs") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.foul_fume_logs.title.1")
        ...
        this.page("${parent.categoryId()}.${ID}.whiff_of_magic") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.whiff_of_magic.title.1")
        ...
        this.page("${parent.categoryId()}.${ID}.odor_of_purity") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.odor_of_purity.title.1")
        ...
        this.page("${parent.categoryId()}.${ID}.reek_of_misfortune") {
            BookOvenFumingPageModel.create().withText("${parent.categoryId()}.${ID}.reek_of_misfortune.title.1")
