...
class WerewolfLevelFourEntryProvider(val id: String, parent: CategoryProviderBase?) : EntryProvider(parent) {
    ...
    override fun generatePages() {
        ...
        this.page("wicker_image") {
            BookImagePageModel.create()
                .withImages(Witchery.id("textures/gui/modonomicon/images/blood_wicker.png"))
        }
    }
