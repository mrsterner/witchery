...
object WitcheryRitualRecipeProvider {
    ...
    fun ritual(exporter: RecipeOutput) {
        ...
        RitualRecipeBuilder.create()
            .addInputItem(Items.LIGHTNING_ROD)
            .addInputItem(WitcheryItems.WOOD_ASH.get())
            .setAltarPower(1000)
            .setTicks(20)
            .addSmallPattern(WitcheryBlocks.RITUAL_CHALK_BLOCK.get())
        ...
        RitualRecipeBuilder.create()
            .addInputItem(Items.WIND_CHARGE)
            .addInputItem(Items.REDSTONE)
            .setAltarPower(500)
            .setAltarPowerPerSecond(16)
            .setInfinite(true)
            .addSmallPattern(WitcheryBlocks.RITUAL_CHALK_BLOCK.get())
        ...
        RitualRecipeBuilder.create()
            ...
            .addInputItem(Items.SWEET_BERRIES)
            .addInputItem(Items.ARMADILLO_SCUTE)
        ...
        RitualRecipeBuilder.create()
            ...
            .addInputItem(Items.GOLD_NUGGET)
        ...
        RitualRecipeBuilder.create()
            ...
            .addInputItem(Items.GLOW_BERRIES)
            .addInputItem(WitcheryItems.ARTHANA.get())
        ...
        RitualRecipeBuilder.create()
            .addInputItem(WitcheryItems.ATTUNED_STONE.get())
            .addInputItem(WitcheryItems.ARTHANA.get())
            .addInputItem(Items.SOUL_LANTERN)
            .setAltarPower(6000)
            .setCelestialConditions(setOf(RitualRecipe.Celestial.NIGHT))
            .addMediumPattern(WitcheryBlocks.RITUAL_CHALK_BLOCK.get())
        ...
        RitualRecipeBuilder.create()
            .addInputItem(WitcheryItems.TAGLOCK.get())
            .addInputItem(WitcheryItems.EXHALE_OF_THE_HORNED_ONE.get())
            .addInputItem(Items.PRISMARINE_SHARD)
        ...
        RitualRecipeBuilder.create()
            ...
            .addMediumPattern(WitcheryBlocks.RITUAL_CHALK_BLOCK.get())
            .setCelestialConditions(setOf(RitualRecipe.Celestial.DAY))
            .setTicks(20)
        ...
        RitualRecipeBuilder.create()
            ...
            .addLargePattern(WitcheryBlocks.INFERNAL_CHALK_BLOCK.get())
            .setCelestialConditions(setOf(RitualRecipe.Celestial.WANING, RitualRecipe.Celestial.NEW_MOON))
            .setTicks(20 * 10)
        ...
        RitualRecipeBuilder.create()
            ...
            .addInputItem(WitcheryItems.SPECTRAL_DUST.get())
            .setCelestialConditions(setOf(RitualRecipe.Celestial.WAXING, RitualRecipe.Celestial.FULL_MOON))
            .addMediumPattern(WitcheryBlocks.INFERNAL_CHALK_BLOCK.get())
            .setAltarPower(5000)
        ...
        RitualRecipeBuilder.create()
            .addInputItem(WitcheryItems.TAGLOCK.get())
            .addInputItem(WitcheryItems.ENDER_DEW.get())
            .addInputItem(WitcheryItems.TORMENTED_TWINE.get())
            .addInputItem(WitcheryItems.NECROMANTIC_STONE.get())
            .setCelestialConditions(setOf(RitualRecipe.Celestial.WANING, RitualRecipe.Celestial.NEW_MOON))
            .addMediumPattern(WitcheryBlocks.INFERNAL_CHALK_BLOCK.get())
            .setAltarPower(5000)
            .setCustomRitual(SoulSeveranceRitual())
            .save(exporter, Witchery.id("soul_severance"))
