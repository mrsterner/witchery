...
class WitcheryBlockTagProvider(
    ...
    override fun addTags(wrapperLookup: HolderLookup.Provider) {
        ...
        tag(WitcheryTags.ALDER_LOGS).add(
        ...
        tag(WitcheryTags.HAWTHORN_LOGS).add(
        ...
        tag(WitcheryTags.CANDELABRAS).add(
        ...
        tag(BlockTags.CROPS)
            ...
            .add(WitcheryBlocks.BELLADONNA_CROP.get())
        ...
        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/lime")))
            .add(WitcheryBlocks.LIME_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/pink")))
            .add(WitcheryBlocks.PINK_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/gray")))
        ...
        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/cyan")))
        ...
        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/blue")))
            .add(WitcheryBlocks.BLUE_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/brown")))
            .add(WitcheryBlocks.BROWN_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/green")))
            .add(WitcheryBlocks.GREEN_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/red")))
            .add(WitcheryBlocks.RED_IRON_CANDELABRA.get())

        tag(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("c", "dyed/black")))
        ...
        tag(WitcheryTags.NETHER_FOLIAGE)
        ...
        tag(WitcheryTags.OVERWORLD_FOLIAGE)
