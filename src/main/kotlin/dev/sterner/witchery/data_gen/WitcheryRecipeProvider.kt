...
import dev.sterner.witchery.data_gen.recipe.*
...
class WitcheryRecipeProvider(output: PackOutput, val registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    override fun buildRecipes(exporter: RecipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WitcheryItems.CRYSTAL_BALL.get())
            .pattern("S")
            .pattern("D")
            .define('S', WitcheryItems.SEER_STONE.get())
