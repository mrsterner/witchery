...
class SnowbellCropBlock(properties: Properties) : WitcheryCropBlock(properties) {

    override fun getBaseSeedId(): ItemNameBlockItem = WitcheryItems.SNOWBELL_SEEDS.get()
